...
export default function Appointment2() {
  ...
  const handlechange11 = (e) => {
    const valuedoctor = e.target.value;
    // setDataConfirm1({ ...dataConfirm1, [name]: value });
    setFunction(valuedoctor);
  };
  const setFunction = async (valuedoctor) => {
    try {
      const response = await axios.post(
        `${baseurl}appointmentByDoctorId/${valuedoctor}`
      );
      if (response.data.success === true) {
        handleclose111();
  ...
  // console.log(item)
  // try {
  //   const resonse = await axios.put(`${baseurl}cancelAppointmentStatus/${item.id}`)
  //   if(resonse.data.sucess===true){
  //     console.log(resonse)
  //   Swal.fire("success","Cancel appointment success","success")
  //   }else{
  //     console.log(resonse.data)
  //   }
  //   // cancelAppointmentStatus/64
  // } catch (error) {
                ...
                <div className="modal-dialog modal-lg">
                  <div className="modal-content">
                    ...
                    <div className="modal-body appointmentDetails">
                      <div className="d-flex justify-content-between">
                        <select
                          className="w-100 bg-white rounded form-select"
                          name="doctor"
                    ...
                    <div className="calendar-container">
                      <div className="calendar-grid">
                        ...
                        {appointmentpatiemt.map((app, index) => {
                          ...
                          const startHour = convertToHourFromTimeString(
                            app.startTime
                          );
                          const endHour = convertToHourFromTimeString(
                            app.endTime
                          );
              ...
              <div className="modal-content">
                ...
                <div className="modal-body appointmentDetails">
                  ...
                  <div className="d-flex justify-content-center mt-3">
                    ...
                    <button className="borderBtn me-2">Confirm</button>
                  </div>
                </div>
              </div>
            </div>
