                            ...
                            <div>
                              <div className="row">
                                ...
                                <div className="col-md-12">
                                  ...
                                  >
                                    <div className="personaimg text-center"></div>
                                    <div>
                                ...
                                <div className="col-md-4 rightSidePer"></div>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div className="modal-body appointmentDetails">
                  <div className="d-flex justify-content-between">
                    <div className="parentDetailApp">
                      <div className="appDeailsImg">
                        <img src={`${baseurImage}${datamodalappointment?.profileImage}`} alt=""  />
                      </div>
                      <div>
                        <p>
                          <strong>Date :</strong>{" "}
