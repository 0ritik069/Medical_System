...
export default function ManageAppointment() {
  ...
  const getDataa = async () => {
    // http://192.168.1.41:4400/api/getPatientVitalsByPatientId/60
  ...
  const handleapisubmit = async () => {
    ...
    try {
      ...
      if (response.data.success === true) {
        getDataa();
        Swal.fire("Success", "Vitals added scussfully", "success");
        setFormData(null);
        handlecloseVital();
        getDataa();
      } else {
  ...
  const handleclikdeleteapp = async (item) => {
    console.log(item);
    try {
      const response = await axios.delete(`${baseurl}deleteAppointments/${item.id}/${location.state.patientid.id}`);
      if (response.data.success === true) {
        getdata()
        Swal.fire(
          "success",
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-6 mb-3">
                              ...
                              <input
                                ...
                                // style={getColorStyle(
                                //   getColorCode("systolic", formData.systolic)
                                // )}
                                className="form-control"
                              />
                            </div>
